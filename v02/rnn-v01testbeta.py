...
model.add(LSTM(units=5, return_sequences=True, input_shape=(5, 1)))
...
model_path = 'Afghanistan/nan/trained_weights_100.h5'
...
for i in range(5, 63):
    ...
    CX_test = np.reshape(X_test, (1, 5, 1))
