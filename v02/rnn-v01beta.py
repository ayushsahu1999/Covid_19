...
CX_val, CY_val = CX_train[40:47, :, :], CY_train[40:]
CX_train, CY_train = CX_train[0:40, :, :], CY_train[0:40]
...
model.add(LSTM(units=15, return_sequences=True, input_shape=(CX_train.shape[1], 1)))
...
model.fit(CX_train, CY_train, epochs=50, batch_size=5, validation_data=(CX_val, CY_val))

p1 = 'Afghanistan/nan/trained_weights.h5'
